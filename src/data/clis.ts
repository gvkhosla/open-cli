...
const intentSlugBoosts = [
  ...
  { terms: ["sqlite"], slugs: ["sqlite-utils", "litecli", "usql", "duckdb", "harlequin"] },
  { terms: ["email", "gmail", "calendar", "workspace", "inbox"], slugs: ["gws", "gcalcli", "himalaya"] },
  { terms: ["tmux", "zellij", "multiplexer", "terminal session"], slugs: ["zellij", "tmux"] },
  { terms: ["ast-grep", "codemod", "structural search"], slugs: ["ast-grep", "rg"] },
  { terms: ["browser", "automation", "playwright", "scrape"], slugs: ["browser-use", "playwright", "firecrawl"] },
  { terms: ["coding cli", "coding clis", "coding agent", "coding agents", "code agent", "terminal agent", "agent cli"], slugs: ["pi", "pi-tinker", "founder-skills", "preflight", "amp", "claude-code", "codex", "cursor-agent", "opencode", "crush", "aider", "gemini-cli", "pickbrain", "ast-grep"] },
