...
const intentSlugBoosts = [
  ...
  { terms: ["coding cli", "coding clis", "coding agent", "coding agents", "code agent", "terminal agent", "agent cli"], slugs: ["pi", "pi-tinker", "founder-skills", "preflight", "amp", "claude-code", "codex", "cursor-agent", "opencode", "crush", "aider", "gemini-cli", "pickbrain"] },
